...
export interface ApiActivityActivity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['training', 'meeting', 'workshop', 'introduction']
    > &
      Schema.Attribute.Required &
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'SCEAR events - Roman reenactment activities';
    displayName: 'Event';
    pluralName: 'events';
    singularName: 'event';
  };
...
export interface ApiGalleryItemGalleryItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'SCEAR photo gallery - Historical reenactment photos';
...
export interface ApiHistoryArticleHistoryArticle
  ...
  info: {
    description: 'SCEAR historical articles about Roman auxiliary forces';
  ...
  attributes: {
    author: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'SCEAR'>;
    category: Schema.Attribute.Enumeration<
      [
        'auxiliary-forces',
        'equipment',
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'auxiliary-forces'>;
